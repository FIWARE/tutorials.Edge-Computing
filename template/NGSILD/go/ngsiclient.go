...
func UpdateLdContext(updateCtx map[string]interface{}, IoTBrokerURL string) error {
	...
	req.Header.Add("Accept", "application/ld+json")
	req.Header.Add("Link", "<https://fiware.github.io/data-models/context.jsonld>; rel=\"https://uri.etsi.org/ngsi-ld/v1/ngsi-ld-core-context-v1.6.jsonld\"; type=\"application/ld+json\"")
	res, err := http.DefaultClient.Do(req)
	if res != nil {
